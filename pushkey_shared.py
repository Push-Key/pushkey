...
AGENT_TOKENS_FILE = VAULT_DIR / "agent_tokens.enc"
HEALTH_PORT = 7654
...
UPGRADE_MESSAGES = {
    "max_agent_tokens": ("🤖 Agent tokens require Pro+",     "Upgrade to create scoped agent tokens.", "pro"),
    ...
    "dual_rotation":   ("🔄 Dual-key rotation is Pro+",      "Upgrade to pre-stage backup keys.",     "pro"),
}
