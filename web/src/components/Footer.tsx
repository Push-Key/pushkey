        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              ...
              <a href="#" className="transition-colors text-xs font-mono flex items-center gap-1" style={{ color: "#64748B" }}
                onMouseEnter={e => (e.currentTarget.style.color = "#F8FAFC")}
                onMouseLeave={e => (e.currentTarget.style.color = "#64748B")}>
                <ExternalLink size={14} />
                X/Twitter
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Features", "Security", "Pricing", "Changelog", "Roadmap"].map(item => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["GitHub Actions", "Vercel", "Railway", "VS Code Extension", "25+ Providers"].map(item => (
                <li key={item}>
                  <a href="#" className="text-sm transition-colors" style={{ color: "#64748B" }}
                    onMouseEnter={e => (e.currentTarget.style.color = "#94A3B8")}
                    onMouseLeave={e => (e.currentTarget.style.color = "#64748B")}>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Privacy Policy", "Terms of Service", "License (MIT)", "Security Policy"].map(item => (
                <li key={item}>
                  <a href="#" className="text-sm transition-colors" style={{ color: "#64748B" }}
                    onMouseEnter={e => (e.currentTarget.style.color = "#94A3B8")}
                    onMouseLeave={e => (e.currentTarget.style.color = "#64748B")}>
