...
This page covers the shipped MCP integration. Browser and VS Code extensions are beta/deferred and documented separately.

## Start the server

```bash
python pushkey_mcp.py
# SSE mode (VS Code Copilot and other MCP clients with SSE support)
